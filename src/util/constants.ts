...
export const ENV_VAR_IONIC_ANGULAR_OPTIMIZATION_ENTRY_POINT = 'IONIC_ANGULAR_OPTIMIZATION_ENTRY_POINT';
export const ENV_VAR_IONIC_ANGULAR_FESM_ENTRY_POINT = 'IONIC_ANGULAR_FESM_ENTRY_POINT';
